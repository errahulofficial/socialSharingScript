<?php
class telegram_channels extends MY_Controller {
                ...
                if($profiles["ok"] == 1){
                    ...
                    if(!empty($profiles['result'])){
                        ...
                        foreach ($profiles['result'] as $profile) {
                            if(isset($profile['channel_post'])){
                                $result[] = (object)[
                                    'id' => $profile['channel_post']['chat']['id'],
                                    'name' => $profile['channel_post']['chat']['title'],
                                    'avatar' => "https://ui-avatars.com/api?name=".$profile['channel_post']['chat']['title']."&size=128&background=0088cc&color=fff",
                                    'desc' => isset($profile['channel_post']['chat']['username'])?$profile['channel_post']['chat']['username']:$profile['channel_post']['chat']['title'],
                                ];                            
                                $count_profile++;
                            }
                        }                        
