<div class="ig-ac-settings">
	...
	<div class="ig-ac-log">
		...
		<ul class="ig-ac-log-memu">
			...
			<li class="<?php _e( segment(5)=="direct"?"active":"" )?>" ><a href="<?php _e( get_module_url("page/log/".segment(4))."/direct" )?>" class="ig-ac-log-type" data-type="direct"><?php _e("Auto bot messages")?></a></li>
