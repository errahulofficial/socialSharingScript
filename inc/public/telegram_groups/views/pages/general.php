<div class="widget-box-add-account">
	...
	<ul class="list-group m-t-25">
		<li class="list-group-item active bg-info text-uppercase"><i class="far fa-question-circle"></i> <?php _e("How to add groups")?></li>
		<li class="list-group-item"><?php _e("Step 1: Add bot is an admin on your groups") ?></li>
		<li class="list-group-item"><?php _e("Step 2: Send a message to groups as you want add") ?></li>
