...
<div class="form-group">
    ...
    <div>
        ...
        <label class="i-checkbox i-checkbox--tick i-checkbox--brand m-r-10">
        	...
        	<input type="checkbox" name="igac_status_direct" <?php _e( get_option('igac_status_direct', 0) ? "checked" : "" ) ?> value="1"> <?php _e("Auto bot message")?>
        	<span></span>
        </label>
        <label class="i-checkbox i-checkbox--tick i-checkbox--brand m-r-10">
...
<div class="form-group">
	...
	<div class="row m-b-15">
		...
		<div class="col">
			<label for="igac_speeds_slow_direct"><?php _e('Auto bot messages/hour')?></label>
	...
	<div class="row m-b-15">
		...
		<div class="col">
			<label for="igac_speeds_normal_direct"><?php _e('Auto bot messages/hour')?></label>
	...
	<div class="row">
		...
		<div class="col">
			<label for="igac_speeds_fast_direct"><?php _e('Auto bot messages/hour')?></label>
