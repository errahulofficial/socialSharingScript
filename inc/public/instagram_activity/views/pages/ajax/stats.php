...
<div class="col-md-4 col-sm-6 m-b-30">
	<div class="widget-card p-20">
		<div class="widget-details wrap-m">
			<div class="widget-info wrap-c">
				<div class="widget-title text-info text-uppercase"><?php _e("Auto bot message action")?></div>
				<div class="widget-desc"><?php _e("Total of Auto bot message actions")?></div>
			</div>
